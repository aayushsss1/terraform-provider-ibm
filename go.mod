...
require (
	...
	github.com/IBM/secrets-manager-go-sdk v1.0.50
...
// replace github.com/IBM/secrets-manager-go-sdk/secretsmanagerv2 => ./github.com/IBM/secrets-manager-go-sdk/secretsmanagerv1
